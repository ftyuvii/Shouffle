    ...
    def __init__(self, view_id: str):
        options = [
            ...
            discord.SelectOption(
                ...
                emoji="️<:infoicon:1515660285850157137>",
                value="2",
            ),
            discord.SelectOption(
...
class HelpView(discord.ui.View):
    ...
    def __init__(self, embeds: list, author: discord.User | discord.Member):
        ...
        self.add_item(HelpButtons("<:leftarrow:1515660267097297026>, discord.ButtonStyle.blurple, f"prev_{uid}"))
        self.add_item(HelpButtons("<:rightarrow:1515660270557466685>", discord.ButtonStyle.blurple, f"next_{uid}"))
...
class Help(commands.Cog):
    ...
    def create_help_embeds(self) -> list[discord.Embed]:
        ...
        embed1 = discord.Embed(
            title="<:Bot:1514196657644765205> Start with Shouffle",
            description=(
                "<:infoicon:1515660285850157137> Use the navigation panel below to browse modules and all existing commands."
            ),
            color=RED,
        )
        embed1.add_field(
            ...
            value=(
                "<:Bot:1514196657644765205> **Page 1:** Home Index\n"
                "<:leaf:1515660279944319006> **Page 2:** General & Utility\n"
                "<:cloud:1515660282771542016> **Page 3:** Moderation & Automod\n"
                "<:shield:1515660276270239804> **Page 4:** Admin & Security"
            ),
            inline=False,
        )
        embed1.add_field(
            name="",
            value=(
                f"<:infoicon:1515660285850157137> Prefix: `{PREFIX}`\n"
                f"<:infoicon:1515660285850157137> Library: `discord.py 2.x`\n"
                f"<:cloud:1515660282771542016> [Shouffle Home](https://discord.gg/nrUJrhxeg8)"
            ),
            inline=False,
        )

        embed2 = discord.Embed(
            title="<:leaf:1515660279944319006> General & Utility Commands",
            description="<:infoicon:1515660285850157137> Everyday basic commands available for all members.",
            color=RED,
        )
        embed2.add_field(
    ...
    "autoresponder, removeresponder, listresponders, gcreate, gend, greroll"
            ),
            inline=False,
        )

        embed3 = discord.Embed(
            title="️<:cloud:1515660282771542016> Moderation & Automod Panel",
            description="<:infoicon:1515660285850157137> Tools for staff members to maintain server decorum.",
            color=RED,
        )
        embed3.add_field(
            name="Available Commands",
        ...
        embed4 = discord.Embed(
            title="<:shield:1515660276270239804> Admin & Securities Panel",
            description="<:infoicon:1515660285850157137> High-tier restrictions and system security configurations.",
            color=RED,
        )
        embed4.add_field(
            name="<:cloud:1515660282771542016> Setup & Core Settings",
            value=(
                "welcomesetup, welcomechannel, welcometest,\n"
                "welcomeconfig, ticketsetup,ticketconfig, autorole, botslogs enable, botlogsdisable"
            ),
            inline=False,
        )
    ...
    async def help_prefix(self, ctx: commands.Context):
        try:
            ...
            await ctx.send(f"<:cross:1514194117985570888> Failed to build help menu: `{e}`")
            return
    ...
    async def help_slash(self, interaction: discord.Interaction):
        try:
            ...
            await interaction.response.send_message(
                f"<:cross:1514194117985570888> Failed to build help menu: `{e}`", ephemeral=True
            )
            return
